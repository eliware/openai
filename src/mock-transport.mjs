export function createMockResponsesTransport(events = [], options = {}) {
  ...
  return class MockResponsesWebSocket {
    ...
    constructor(url = '', protocols) {
      ...
      this.listeners = new Map(); this.sent = []; this.closed = false; this._events = [...events];
    ...
    close(code = 1000, reason = 'OK') { if (this.readyState === 3) return this; this.readyState = 3; this.closed = { code, reason }; this.emit('close', code, reason); return this; }
  };
}
